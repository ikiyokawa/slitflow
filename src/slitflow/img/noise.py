...
class Gauss(Image):
    ...
    Args:
        ...
        param["sigma"] (float): The standard deviation of gauss noise
        param["baseline"] (float): The baseline value of background
    ...
    def set_info(self, param={}):
        ...
        self.info.add_param("sigma", param["sigma"], col_info["unit"],
                            "The standard deviation of gauss noise")
        self.info.add_param("baseline", param["baseline"], col_info["unit"],
                            "The baseline value of background")
        if "seed" in param:
